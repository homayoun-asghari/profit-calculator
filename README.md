...
>
> **The commit date is the real modification time of the original file**, recovered with `stat`: `2019-10-09 07:39:08` local time (UTC+03:30). One commits are dated 2026 — the README, plus any rendered previews or corrections. Each says which it is in its commit message.
